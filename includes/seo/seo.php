...
function web589_post_meta_box(){
	add_meta_box('web589_post_meta_box','自定义seo meta','Web589Meta_postmeta_form','post','normal','high');
	add_meta_box('web589_post_meta_box','自定义seo meta','Web589Meta_postmeta_form','page','normal','high');
}
...
function web589_cat_meta_box(){
	if( isset($_GET['action']) && $_GET['action']=='edit' ) include_once('cat-form.php');
}
...
function web589_tag_meta_box(){
	if( $_GET['action']=='edit' ) include_once('tag-form.php');
}
